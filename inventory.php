...
<p style="font-family:Agency FB;color:black;font-size:50px;line-height:120%;margin-left:80px"> 
...
$header=array('Tools ','On-hand ','Deployed','Retired','Damaged','Missing', 'ForExchange', 'Total');
for ($a=0;$a<1;$a++)
{
...
{
  echo '<a href='."./inventory.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./inventory.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}
