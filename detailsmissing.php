...
D E T A I L S - &emsp; M I S S I N G &emsp; E Q U I P M E N T
...
$TotalRec = mysql_result(mysql_query("SELECT COUNT(*) FROM serialnumber WHERE status='Missing'"), 0);

$select = "SELECT * FROM serialnumber WHERE status='Missing' LIMIT $start, $perpage";
...
{
  echo '<a href='."./detailsmissing.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./detailsmissing.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}
