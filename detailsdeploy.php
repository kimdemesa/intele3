...
D E T A I L S - &emsp; D E P L O Y E D &emsp; E Q U I P M E N T
...
$TotalRec = mysql_result(mysql_query("SELECT COUNT(*) FROM serialnumber WHERE status='Deployed'"), 0);

$select = "SELECT * FROM serialnumber WHERE status='Deployed' LIMIT $start, $perpage";
...
{
  echo '<a href='."./detailsdeploy.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./detailsdeploy.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}
