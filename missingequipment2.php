...
$query="UPDATE tools SET Missing=Missing+'$_POST[quantity]' WHERE Tools='$_POST[item]'";
$is_query_successful=mysql_query($query); 




$query="INSERT INTO missing (date, person, office, item, quantity, reason)
...
<a style="font-family:Agency FB;color:green;font-size:20px;line-height:120%;text-align:center;margin-top:80px" href="missingequipment.php"><p style="font-family:Agency FB;font-size:20px;color:black;line-height:80%;text-align:center;margin-top:20px"> Add record</a></p>
