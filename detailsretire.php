...
D E T A I L S - &emsp; R E T I R E D &emsp; E Q U I P M E N T
...
$TotalRec = mysql_result(mysql_query("SELECT COUNT(*) FROM serialnumber WHERE status='Retired'"), 0);

$select = "SELECT * FROM serialnumber WHERE status='Retired' LIMIT $start, $perpage";
...
{
  echo '<a href='."./detailsretire.php?id=" . ($start - $perpage) . '>'."Previous".'</a>';
}?>
...
{
  echo '<a href='."./detailsretire.php?id=" . ($start + $perpage) . '>'."Next".'</a>';
}end:
?>
